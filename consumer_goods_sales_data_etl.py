# -*- coding: utf-8 -*-
"""consumer_goods_sales_data_etl.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Jen1S0UfbdYBiIdZrBnEbPPDQO7Md0a7
"""
...
from fx_optimal_datetime import generate_period_table
...
dim_locations = pd.read_csv("Dim_Locations.csv", index_col=None)
fact_orders = pd.read_csv("Fact_Orders.csv", index_col=None)
...
dim_period.to_csv('Dim_Period.csv', encoding='utf-8', index=False)
...
dim_locations.to_csv('Dim_Locations.csv', encoding='utf-8', index=False)
dim_period.to_csv('Dim_Period.csv', encoding='utf-8', index=False)
fact_orders.to_csv('Fact_Orders.csv', encoding='utf-8', index=False)
...
connection = sqlite3.connect('#US_Consumer_Goods_Sales.db')
